...
public record TeamDetailResponse(
        ...
        @Schema(description = "[팀 루프] 전체 루프 개수")
        int totalLoopCount,

        @Schema(description = "[팀 루프] 팀 전체 평균 진행률")
        double teamTotalProgress,

        @Schema(description = "[내 루프] 내가 참여하는 루프 개수")
        int myLoopCount,

        @Schema(description = "[내 루프] 나의 평균 진행률")
        double myTotalProgress
) {}